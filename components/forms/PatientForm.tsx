    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className={'space-y-6 flex-1'}>
                ...
                <CustomFormField fieldType={FormFieldType.INPUT} control={form.control} name={'email'} label={'Email Address'} placeholder={'johndoe@gmail.com'} iconSrc={'/assets/icons/email.svg'}
                                 iconAlt={'email'}/>
